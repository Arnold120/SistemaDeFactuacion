using SistemaDeFacturacion.Entidades;
    ...
    public static void Main()
     {
        ...
        factura.RegistrarPago(300, DateTime.UtcNow, "Compra de super eskimo");
        factura.RegistrarPago(120, DateTime.UtcNow, "Compra de un fruta rellena ");
        try
        {
            factura.RegistrarPago(130, DateTime.UtcNow, "Compra de ron con pasa");
        }
